...
A typical way users access video multimedia is through an embedded video on a web page. Typically this has been achieved through the use of third party plug-ins such as Adobe Flash\footnote{Adobe Flash Player: \url{http://www.adobe.com/uk/software/flash/about/}} or Microsoft Silverlight\footnote{Microsoft Silverlight: \url{http://www.microsoft.com/silverlight/}}. Adobe Flash player was well on the way to becoming the de facto standard for embedding video into web pages, %there was a paper that said this I think....
...
P. Oehme et al used the native integration of HTML5 video to add dynamic overlays to a video containing related data from various internet sources\cite{inproceedings:theChroomaApproach}. 
