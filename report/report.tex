...
Once a user obtains the original file, Digital Rights Management (DRM) technologies can be used to prevent playback


HTML5 does not specify a Digital Rights Management (DRM) system \cite{article:HTML5LeadsAWebRevolution}.
% occluding
% - 
