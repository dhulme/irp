...
Instead of using an external text track file, data can be embedded within container formats such as Ogg \cite{inproceedings:accessibilityForTheHTML5VideoElement}\cite{website:oggSubtitles}. However, this is not the direction recommended by the W3C. %citation?
...
\section{Discussion}
\textit{Discussion here. Reviewing all the research done above. Leads towards the conclusion.}

\section{Conclusion}
\textit{Conclusion here. Summarising the key points, short and sweet.}
