...
In HTML5, default video controls can be included using the `controls' attribute on the \textless video\textgreater~tag. However since these controls are not all controllable via the keyboard %citation
